...
Complete catalog of shadcn/ui components with usage patterns.

## Component Availability

**Add specific components:**
```bash
[Operational command intentionally omitted]
[Operational command intentionally omitted]
[Operational command intentionally omitted]
```

Components are typically available under `components/ui/` in projects that use shadcn/ui.
