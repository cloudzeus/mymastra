...
All numbers, testimonials, customer names, logos, ratings, guarantees, case studies, pricing, product capabilities, and performance outcomes shown in this reference are illustrative structural examples only.

For real customer work:

- use only verified evidence from authoritative inputs;
- never invent metrics, quotes, logos, ratings, guarantees, pricing, integrations, customer names, or results;
- if evidence is unavailable, omit the proof element or explicitly mark it as unresolved;
- do not convert a placeholder or example into a factual customer claim.
...
**[Verified number] [verified audience/customer group] use [product] to [verified outcome]**
> [Verified customer count] [audience] use [product] to [verified outcome]
...
> What if you could [verified desirable outcome]?
...
- Verified key metric when supplied by an authoritative source
- Verified star rating and review count when authoritative evidence is available
...
- Repeat primary CTA
- Verified risk reversal when an actual guarantee, trial, or commercial term exists
...
- Verified money-back guarantee when contractually available
- Verified free-trial terms when available
- Verified cancellation terms
- Reduces friction

**Stats Section**
- Use only verified metrics that build credibility
- Verified customer count
- Verified rating and review count
- Verified quantified customer outcome
...
- **Proof**: Verified number, verified testimonial, or grounded example (optional)
...
Example:
1. Connect your tools ([verified setup-time claim, if available])
2. Set your preferences
3. Get automated reports on the verified configured schedule

### Testimonial Selection

When verified testimonials are available, stronger examples include:
