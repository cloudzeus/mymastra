...
This is the tool-agnostic half of "copy any viral edit": the *decomposition*. The downstream production method is separate from this decomposition step. The specification is the deliverable.
...
## Step 4 — Review and approve the specification
...
After approval, the specification can be handed to an authorized production workflow:
